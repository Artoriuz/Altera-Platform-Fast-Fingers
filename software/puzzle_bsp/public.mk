...
SOPCINFO_FILE := C:/altera/13.0/projeto/final.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x9040
SOPC_SYSID_FLAG += --sidp=0x9040
ELF_PATCH_FLAG  += --sidp 0x9040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1498052167
SOPC_SYSID_FLAG += --timestamp=1498052167
ELF_PATCH_FLAG  += --timestamp 1498052167
